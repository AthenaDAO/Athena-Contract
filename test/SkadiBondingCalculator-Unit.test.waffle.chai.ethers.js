...
describe('AthenaBondingCalculator', () => {
    ...
    beforeEach(
      async function() {
        ...
        MIMContract = await ethers.getContractFactory('MIM');
        tt1 = await MIMContract.connect(deployer).deploy(0);

        AVAXContract = await ethers.getContractFactory('AVAX');
        tt2 = await AVAXContract.connect(deployer).deploy(0);
        ...
        BondingCalcContract = await ethers.getContractFactory('AthenaBondingCalculator');
    ...
    describe(
      ...
      () => {
        it(
          "calcDebtfRatioForToken( address deployer, address tokenToCalcDebt_, address debtCalcToConsult_ )",
          async () => {
